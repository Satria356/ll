...
⬡│メ *Money:* %money
⬡│メ *Role:* %role
⬡│メ *Level:* %level [ %xp4levelup Xp For Levelup]
⬡│メ *Xp:* %exp / %maxexp
┬│メ *Total Xp:* %totalexp
│╰────────────────···
┠─────═[ TODAY ]═─────⋆
│╭────────────────···
┴│    *${ucapan()} %name!*
⬡│メ *Tanggal:* %week %weton
⬡│メ *Date:* %date
⬡│メ *Tanggal Islam:* %dateIslamic
┬│メ *Waktu:* %time
│╰────────────────···
┠─────═[ INFO BOT ]═─────⋆
│╭────────────────···
...
⬡│メ *Mode:* %mode
⬡│メ *Prefix:* [ *%_p* ]
⬡│メ *Baileys:* Multi Device
⬡│メ *Battery:* ${conn.battery != undefined ? `${conn.battery.value}% ${conn.battery.live ? '🔌 pengisian' : ''}` : 'tidak diketahui'}
⬡│メ *Platform:* %platform
⬡│メ *Type:* Node.Js
⬡│メ *Uptime:* %muptime
┬│メ *Database:* %rtotalreg dari %totalreg
│╰────────────────···
╰──────────═┅═──────────
            ...
            templateButtons: [
                {
                    urlButton: {
                        displayText: `${namebot}`,
                        url: 'https://github.com/ISatria356'
                    }
                },
                {
                    urlButton: {
